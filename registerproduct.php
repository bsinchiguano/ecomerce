      ...
      <div class="service">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     <h2>Registrar <strong class="black">Productos</strong></h2>
                  </div>
               </div>
            </div> 
            <div class="row">
                    <form class="main_form" method="post" action="guardarproducto.php">
                        <div class="row">
                            ...
                            <div class=" col-md-12">
                                <input class="form-control" type="text" name="cantidad_producto" placeholder="Ingresar Cantidad del Producto">
                            </div>
                            <div class=" col-md-12">
                                <input class="form-control" type="text" name="precio_producto" placeholder="Ingresar Precio del Producto">
                            </div>
                            <div class=" col-md-12">
