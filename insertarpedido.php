...
if(!isset($_SESSION['CARRITO'])){header("Location: ./indexcliente.php");}
...
$conexion-> query("INSERT INTO ventas(id_usuario,total,fecha,status,id_pago) VALUES ($id_usuario,$total,'$fecha','preparacion',56)")or die($conexion->error);
